...
const page = () => {
  return (
    <div className='w-11/12 mt-20 mx-auto text-white min-h-screen'>
        ...
        <p className='mt-4 text-lg'>Demo is a music search engine using open source APIs and does not upload or host any files on it's server. If you are a valid owner of any content listed here & want to remove it then please send us an DMCA formatted takedown notice at <a href='mailto:typicallyalpha@gmail.com' className=' text-cyan-400'>email</a>. We will remove your content as soon as possible.</p>
        ...
        <h2 className='mt-4 text-2xl font-bold'>DMCA takedown request requirements</h2>
        <p className='mt-4 text-lg'>To submit a DMCA request, please provide the following information:</p>
        <ul className='list-disc list-item'>
            ...
            <li>A statement that the complaining party has a good faith belief that use of the material in the manner complained of is not authorized by the copyright</li>
        ...
        <h2 className='mt-4 text-xl font-bold'>Demo does not store any files on our server, we only linked to the media which is hosted on 3rd party services.</h2>
    </div>
  )
}
